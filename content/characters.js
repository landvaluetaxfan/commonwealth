...
const CHARACTERS = [
  ...
  { id:"marin", name:"Florence Marin MP", role:"",
    party:"rv", seat:"Concord—Bellfield", relationship:49,
    note:"Backbench. Gave the portfolio up to a functional seat without a public word." },
  ...
  /* Three portfolios held from functional seats: the sector elects the minister
  ...
  { id:"abadi", name:"Nadia Abadi MP", role:"Minister for Persons and Continuity",
    party:"rv", functional:"fc_medicine", relationship:49, office:"minister",
    note:"Embodiment medicine meeting continuity of soul, which is the ministry's whole argument." },
  ...
  { id:"nadeau", name:"Vesna Nadeau MP", role:"Shadow Minister for Trade and the Anchors",
    party:"cl", seat:"Halvard Centre", relationship:25, office:"shadow",
    note:"Wants the anchors opened to consortium capital and the trade index treated as a scoreboard." },
