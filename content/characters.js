...
const CHARACTERS = [
  ...
  { id:"hatt", name:"Edward Hatt", role:"Leader, Alliance of Business and Government",
  ...
  { id:"wheeler", name:"Marion Wheeler", role:"Leader, Single Tax Party",
    party:"geo", relationship:57, office:"leader",
    note:"Volume tax, land value tax, nothing else. Correct. List tier only." },
  { id:"lindegaard", name:"Aalbord Lindegaard", role:"Leader, Common Kind",
    party:"upl", relationship:50, office:"leader",
    note:"Two seats, permanently kingmaker-adjacent. Price is always the same thing." },

  /* ---- backbenchers, seated ---- */
  { id:"vanryneveld", name:"Jaco van Ryneveld MP", role:"",
    party:"ind", seat:"Stanbridge", relationship:44,
    note:"Biologically augmented: cat ears. A body-mod, and unbothered by it." },
  { id:"clarke", name:"Benj Clarke MP", role:"",
    party:"hul", seat:"Lindenhall—Peck", relationship:36,
    note:"Backbench. Votes with the engineers when the engineers are voting." },
  { id:"devi", name:"Anil Devi MP", role:"",
    party:"psa", seat:"Coldwater One", relationship:48,
    note:"Backbench. Substrate district, substrate party, no illusions about either." },
  { id:"tanako", name:"Kazuya Tanako MP", role:"",
    party:"sc", seat:"The Rim", relationship:40,
    note:"Backbench. One of the Compact's members who cannot be whipped, by design." },
  ...
  { id:"czarnecki", name:"Dan Czarnecki MP", role:"",
    party:"cu", seat:"Crowfield", relationship:59,
    note:"Backbench. Maintenance family, three generations in the same deck local." },
  ...
  { id:"vidyasagar", name:"Suravaram Vidyasagar MP", role:"",
    party:"cu", seat:"Ambrose Fields", relationship:52,
    note:"Backbench. The sort of member every leadership forgets to count." },
